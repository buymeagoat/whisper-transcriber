...
import { Mic, Shield, Zap, KeyRound } from 'lucide-react'
        ...
        <main className="py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Whisper AI technology. Optimized for a single trusted operator.
            </p>
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Focused on a single secure admin account today, with room to grow when you need more users later.
              </p>
            </div>
          </div>
        </main>
