...
import { Mic, Eye, EyeOff, AlertCircle, Shield } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400 flex items-center justify-center gap-2">
          <Shield className="w-4 h-4" />
          Single-user mode keeps things simple. Use your admin password to sign in.
        </p>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400">
              Need a reset? Update it from the admin dashboard once you're in.
            </div>
